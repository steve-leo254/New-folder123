    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          ...
          { label: 'Active Prescriptions', value: '3', icon: FileText, color: 'bg-green-500' },
          { label: 'Medications to Take', value: '5', icon: Pill, color: 'bg-purple-500' },
          { label: 'Video Consultations', value: '1', icon: Video, color: 'bg-orange-500' }
        ].map((stat, index) => {
