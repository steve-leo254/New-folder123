...
interface SimpleInsuranceSectionProps {
  isEditing: boolean;
  formData: any;
  onFormDataChange: (data: any) => void;
}

export const SimpleInsuranceSection: React.FC<SimpleInsuranceSectionProps> = ({ 
  isEditing, 
  formData, 
  onFormDataChange 
}) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {isEditing ? (
              <select
                name="insuranceType"
                value={formData.insuranceType || 'standard'}
                onChange={handleInputChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
              ...
              <div>
                ...
                {isEditing ? (
                  <input
                    ...
                    value={formData.insuranceQuarterlyLimit || 0}
                    onChange={handleInputChange}
                  ...
                  <div className="w-full px-4 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-900">
                    KSH {(formData.insuranceQuarterlyLimit || 0).toLocaleString()}
                  </div>
                )}
              </div>
