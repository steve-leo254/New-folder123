          ...
          <div className="md:col-span-2">
            ...
            {isEditing ? (
              ...
              <div className="w-full px-4 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-900">
                {formData.emergencyContactName || 'No emergency contact name set'}
              </div>
            )}
          </div>
          <div>
            ...
            {isEditing ? (
              ...
              <div className="w-full px-4 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-900">
                {formData.emergencyContactPhone || 'No phone number set'}
              </div>
            )}
          </div>
          <div>
            ...
            {isEditing ? (
              ...
              <div className="w-full px-4 py-3 border border-gray-200 rounded-lg bg-gray-50 text-gray-900">
                {formData.emergencyContactRelation || 'No relationship specified'}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
          <div className="flex items-start">
            ...
            <div>
              ...
              {!formData.emergencyContactName && !formData.emergencyContactPhone && !formData.emergencyContactRelation && (
                <div className="mt-3 p-3 bg-amber-100 rounded-md">
                  <p className="text-sm font-medium text-amber-800">
                    ⚠️ No emergency contact information set
                  </p>
                  <p className="text-xs text-amber-700 mt-1">
                    Click "Edit Profile" to add your emergency contact details.
                  </p>
                </div>
              )}
            </div>
