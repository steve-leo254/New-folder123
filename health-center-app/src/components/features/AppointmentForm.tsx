...
const AppointmentForm: React.FC<AppointmentFormProps> = ({ doctor, onClose }) => {
  ...
  // Get phone from token (if available)
  ...
  // Handle form submit — creates appointment then opens payment modal
  ...
  const handlePaymentFailed = useCallback(() => {
    ...
    setShowPaymentModal(false);
    // Don't close the form — let user try again or cancel
  }, []);
  ...
  return (
    <>
      ...
      <MpesaPaymentModal
        ...
        amount={doctor?.consultationFee || 2500}
